...
- [[UI Enhancements][UI Enhancements]]
  ...
  - [[Dashboard][Dashboard]]
  - [[Start Layout and Properties][Start Layout and Properties]]
...
** Load Private File
   ...
   #+INCLUDE: "~/.emacs.d/init.el" src emacs-lisp :range-begin "InitPrivate" :range-end "-InitPrivate"  :lines "242-245"
* Package Management
...
*** Dired
    ...
    #+INCLUDE: "~/.emacs.d/elisp/init-dired.el" src emacs-lisp :range-begin "DiredPackage" :range-end "-DiredPackage" :lines "40-111"
*** Disk Usage
    ...
    #+INCLUDE: "~/.emacs.d/elisp/init-dired.el" src emacs-lisp :range-begin "DiskUsage" :range-end "-DiskUsage" :lines "114-116"
*** Save All Buffers
    #+INCLUDE: "~/.emacs.d/elisp/init-dired.el" src emacs-lisp :range-begin "SaveAllBuffers" :range-end "-SaveAllBuffers" :lines "119-125"
** Winner
...
*** Dashboard
    ...
    #+INCLUDE: "~/.emacs.d/elisp/init-dashboard.el" src emacs-lisp :range-begin "DashboardPac" :range-end "-DashboardPac" :lines "39-89"
*** Page Break Lines
...
** Start Layout and Properties
   Defining the windows to be loaded when Emacs starts
      #+INCLUDE: "~/.emacs.d/elisp/init-ui-config.el" src emacs-lisp :range-begin "StartupLayout" :range-end "-StartupLayout" :lines "92-111"
...
*** Line Breaks adjust to window width
    This will enable line breaks.
    #+INCLUDE: "~/.emacs.d/elisp/init-ui-config.el" src emacs-lisp :range-begin "LineWrap" :range-end "-LineWrap" :lines "88"
* General Programming
** Magit
...
** Org
   ...
   *Prerequisite*: Configure =(org-agenda-files (list "~/org/agenda/"))= to your agenda folder to use org-agenda. Once this is set, the agenda items tagged with =DEADLINE= or =SCHEDULED= will be displayed on the [[Dashboard][Dashboard]] (hopefully the dashboard will be more detailed in the [[https://github.com/MatthewZMD/.emacs.d/issues/37][future]]).
   #+INCLUDE: "~/.emacs.d/elisp/init-org.el" src emacs-lisp :range-begin "OrgPac" :range-end "-OrgPac" :lines "39-156"
*** Org-Ref-Cite
    #+INCLUDE: "~/.emacs.d/elisp/init-ref.el" src emacs-lisp :range-begin "Reference" :range-end "-Reference" :lines "50-65"
   

*** Org-ROAM
    Organizing your research with the Zettelkasten-method.
     #+INCLUDE: "~/.emacs.d/elisp/init-org-roam.el" src emacs-lisp :range-begin "OrgROAM" :range-end "-OrgROAM" :lines "50-63"
*** Babel
    Executing code snippets from within an =org-mode= text.
    #+INCLUDE: "~/.emacs.d/elisp/init-org.el" src emacs-lisp :range-begin "OrgBabel" :range-end "-OrgBabel" :lines "111-120"
*** TOC Org
...
** MU4E
   ...
   *Prerequisite*:
   ...
   3. Execute the follwing commands described on the page https://macowners.club/posts/email-emacs-mu4e-macos/
...
** Reveal
   Making sure we get the reveal-js output
   #+INCLUDE: "~/.emacs.d/elisp/init-reveal.el" src emacs-lisp :range-begin "Reveal" :range-end "-Reveal"


** Icons
   #+INCLUDE: "~/.emacs.d/elisp/init-icons.el" src emacs-lisp :range-begin "Icons" :range-end "-Icons"
