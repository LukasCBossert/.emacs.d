...
** Start Layout and Properties
   Defining the windows to be loaded when Emacs starts
      #+INCLUDE: "~/.emacs.d/elisp/init-ui-config.el" src emacs-lisp :range-begin "StartupLayout" :range-end "-StartupLayout" :lines "92-109"
...
*** Modeline Time and Battery
    ...
    #+INCLUDE: "~/.emacs.d/eli/init-ui-config.el" src emacs-lisp :range-begin "DisTimeBat" :range-end "-DisTimeBat" :lines "83-85"
*** Line Breaks adjust to window width
    This will enable line breaks.
    #+INCLUDE: "~/.emacs.d/eli/init-ui-config.el" src emacs-lisp :range-begin "LineWrap" :range-end "-LineWrap" :lines "88"
* General Programming
** Magit
