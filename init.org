...
** Load Private File
   ...
   #+INCLUDE: "~/.emacs.d/init.el" src emacs-lisp :range-begin "InitPrivate" :range-end "-InitPrivate"  :lines "240-243"
* Package Management
...
** Start Layout and Properties
   Defining the windows to be loaded when Emacs starts
      #+INCLUDE: "~/.emacs.d/elisp/init-ui-config.el" src emacs-lisp :range-begin "StartupLayout" :range-end "-StartupLayout" :lines "92-110"
